...
namespace Drakkar
{
	public static class DrakkarEditor
	{
		...
		#region STYLES
		private static GUIStyle rightAlignLabel,rightAlignementBoldLabel,centered_Label,richHelpBox,textAreaWrap,colorPanel;
		...
		public static Rect ExtractRectPercentage(ref Rect container,float perc)
		{
			Rect n=container;
			n.x+=container.width*perc;
			n.width=container.width*perc;
			container.width*=1-perc;
			return n;
		}
		...
		[MethodImpl(MethodImplOptions.AggressiveInlining)]
		public static void ArrayGUI(SerializedObject obj,string name,string displayName="",float indent=0,bool indexed=true,bool overrideColor=false,Type dragnDropType=null,Action<SerializedProperty> addAction=null,Action<UnityEngine.Object,SerializedProperty> dragnDropAction=null)
		{
			EditorGUI.indentLevel=0;
			EditorGUILayout.BeginVertical();
		...
		#endregion
		#region TOGGLE
		public static void Toggle(ref bool b,string text,int width)
		{
		...
		public static void Toggle(ref bool b,string text,int width,Color col)
		{
		...
		public static void Toggle(ref bool b,string text,int width,Color col,GUIStyle style)
		{
			GUI.backgroundColor=b?col:Color.black;
			GUI.contentColor=b?Color.white:Color.gray;
			GUI.color=Color.white;
		...
		public static void Toggle(ref bool b,string text,string tooltip,int width)
		{
			GUI.backgroundColor=b?Color.cyan:Color.black;
			GUI.contentColor=b?Color.white:Color.gray;
			GUI.color=b?Color.cyan:Color.white;
		...
		public static void ToggleShortArrayBit(ref ShortBitArray arr,int bit,string text,int width)
		{
			bool b=arr.Get(bit);
			GUI.backgroundColor=b?Color.cyan:Color.black;
			GUI.contentColor=b?Color.white:Color.gray;
		...
		#region INSPECTORS
		[MethodImpl(MethodImplOptions.AggressiveInlining)]
		public static void PropertyInspector(SerializedObject ob,string pr)
		{
		...
		[MethodImpl(MethodImplOptions.AggressiveInlining)]
		public static void DrakkarPropertyInspector(SerializedObject ob,string pr,float width=-1,bool recolor=false)
		{
			SerializedProperty p=ob.FindProperty(pr);
			EditorGUILayout.PropertyField(p,emptyContent);
			ob.ApplyModifiedProperties();
			OverlappingLabel(p.displayName,recolor? GUI.contentColor : Color.green);
		}
